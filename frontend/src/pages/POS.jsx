...
import { BiBell, BiSync, BiUser, BiChevronRight } from "react-icons/bi";
...
function POS() {
  ...
  // Sample notifications - replace with your actual notifications data
  const notifications = [
    {
      id: 1,
  ...
  const handleProfileClick = () => {
    navigate("/profile"); // Adjust this route to match your profile page route
  };
  ...
  const headerActions = (
    <div className="flex items-center gap-4">
      ...
      {/* Updated Cashier Profile Button */}
      <button
      ...
      <ProfileModal
        ...
        userData={user} // Pass your user data here
      />
    </div>
  );
  ...
  return (
    <PageLayout
      ...
      sidebar={<NavAdmin />}
      headerActions={headerActions} // Add the headerActions here
