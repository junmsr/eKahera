...
const Profile = () => {
  ...
  const fetchProfileData = async () => {
    try {
      ...
      setError("Failed to load profile information. Please check your connection and try again.");
    } finally {
      setLoading(false);
    }
  };
  ...
  return (
    ...
    >
      <div className="p-6 space-y-6">
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 text-center">
            <div className="w-16 h-16 bg-gray-200 rounded-full flex items-center justify-center mx-auto mb-4">
              <svg className="w-8 h-8 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2M12 3v18m0-18a4 4 0 0 1 4 4v1a4 4 0 0 1-4 4 4 4 0 0 1-4-4V7a4 4 0 0 1 4-4z" />
              </svg>
            </div>
          ...
          <div className="p-6">
            <div className="flex items-center mb-6">
              <div className="w-12 h-12 bg-blue-600 text-white rounded-full flex items-center justify-center text-lg font-semibold mr-4">
                {profileData?.user?.username?.charAt(0)?.toUpperCase() || "A"}
              </div>
              <div>
                <h2 className="text-xl font-semibold text-gray-900">Admin Information</h2>
                <p className="text-gray-600">Account and login credentials</p>
              </div>
            </div>
          ...
          <div className="p-6">
            <div className="flex items-center mb-6">
              ...
              <div>
                ...
                <p className="text-gray-600">Business details and credentials</p>
              </div>
            </div>
        ...
        {/* Business Users */}
        {profileData?.business?.users && profileData.business.users.length > 0 && (
          <Card className="bg-white shadow-sm">
            <div className="p-6">
              <div className="flex items-center mb-6">
                ...
                <div>
                  <h2 className="text-xl font-semibold text-gray-900">Business Team</h2>
                  <p className="text-gray-600">All users associated with this business ({profileData.business.total_users} total)</p>
                </div>
              </div>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {profileData.business.users.map((user, index) => (
                  <div key={user.user_id} className="bg-gray-50 rounded-lg p-4 border">
                    <div className="flex items-center mb-3">
                      ...
                      <div>
                        ...
                        <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${
                          user.user_type_name === 'admin' || user.role === 'business_owner' 
                            ? 'bg-red-100 text-red-800' 
                            : user.user_type_name === 'cashier' || user.role === 'cashier'
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      {user.contact_number && (
                        <div>
                          ...
                          <div className="font-medium text-gray-900">{user.contact_number}</div>
                        </div>
                      )}
                      <div>
