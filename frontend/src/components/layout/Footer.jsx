  ...
  return (
    ...
    >
      <div className="relative z-10 max-w-5xl mx-auto px-4 pt-16 pb-2">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12 md:gap-0">
          ...
          <div className="flex-1 min-w-[260px] mb-8 md:mb-0">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span
                className="text-2xl font-extrabold text-blue-700 drop-shadow-sm"
                style={{ fontFamily: "Inter, sans-serif" }}
              >
                ahera
              </span>
            ...
            <ul className="text-sm text-black space-y-3 mb-2">
              <li className="flex items-start gap-3">
                ...
                <span>
                  <span className="font-bold">200, T. De Castro Street</span>
                  <br />
              ...
              <li className="flex items-center gap-3">
                ...
                <span>eKahera-POS@gmail.com</span>
              </li>
              <li className="flex items-center gap-3">
                <svg
                  width="22"
        ...
        <div
          className="w-full h-1 mt-10 mb-2"
          style={{
            background: "linear-gradient(90deg, #e8f0fe 0%, #2563eb 100%)",
            opacity: 0.3,
          }}
        />
        {/* Bottom Bar */}
