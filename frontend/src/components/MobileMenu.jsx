  ...
  return (
    ...
    >
      <ul className="flex flex-col items-center space-y-4 bg-white p-4 rounded-lg shadow-lg">
        <li>
          <a href="/" className="text-gray-700 hover:text-purple-500 font-medium">
            Home
          </a>
        </li>
        <li>
        ...
        <li>
          <button className="bg-purple-500 hover:bg-purple-600 text-white px-6 py-2 rounded-full font-medium cursor-pointer">
            Get Started
          </button>
        </li>
      </ul>
