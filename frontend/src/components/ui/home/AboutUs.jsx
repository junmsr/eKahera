...
const AboutUs = () => {
  ...
  const handlePaperPlaneClick = () => {
    setIsAnimating(true);
    setTimeout(() => {
      navigate("/futurefeatures");
    }, 1000); // Delay navigation to allow animation to complete
  };
    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-start">
          ...
          >
            We build smart, cloud-based POS software designed to help micro,
            small, and midsize businesses sell faster, operate smarter, and
            scale with confidence through real-time management.
          </motion.p>
          ...
          <div className="grid grid-cols-1 gap-6 w-full">
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 text-base md:text-lg leading-relaxed">
                  To deliver a simple, web-based platform that empowers Albay
                  businesses with real-time store management and innovative
                  self-scanning checkout to drive quick growth and customer
                  delight.
                </p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="flex-1">
                ...
                <p className="text-slate-600 text-base md:text-lg leading-relaxed">
                  To be the digital backbone for every MSME in Albay, setting
                  the standard for modern, efficient, and self-service retail.
                </p>
              </div>
            </motion.div>
          </div>
              ...
              <div className="relative flex flex-col gap-6">
                ...
                <div className="flex flex-col items-center mt-6">
                  <motion.div
                    animate={
                      isAnimating
                        ? { x: 500, y: -200, rotate: 45, scale: 1.5 }
                        : {}
                    }
                  ...
                  <span className="text-xs text-slate-500 mt-2">
                    Click the paper plane for future features
                  </span>
                </div>
              </div>
            </div>
