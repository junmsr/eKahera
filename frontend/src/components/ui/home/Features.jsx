...
const features = [
  {
    icon: (
      <svg width="40" height="40" fill="none" stroke="#1976ed" strokeWidth="2.5" viewBox="0 0 24 24"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M16 3v4M8 3v4"/><path d="M3 11h18"/></svg>
    ),
  ...
  {
    icon: (
      <svg width="40" height="40" fill="none" stroke="#1976ed" strokeWidth="2.5" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M7 7h.01M7 11h.01M7 15h.01M11 7h2v2h-2zM11 11h2v2h-2zM11 15h2v2h-2zM15 7h.01M15 11h.01M15 15h.01"/></svg>
    ),
  ...
  {
    icon: (
      <svg width="40" height="40" fill="none" stroke="#1976ed" strokeWidth="2.5" viewBox="0 0 24 24"><path d="M12 21c4.97 0 9-4.03 9-9s-4.03-9-9-9-9 4.03-9 9 4.03 9 9 9z"/><path d="M12 7v4l3 3"/></svg>
    ),
  ...
  {
    icon: (
      <svg width="40" height="40" fill="none" stroke="#1976ed" strokeWidth="2.5" viewBox="0 0 24 24"><rect x="2" y="7" width="20" height="14" rx="2"/><path d="M16 3v4M8 3v4"/><path d="M2 11h20"/></svg>
    ),
...
const Features = () => (
  <section id="features" className="relative w-full py-20 px-2 bg-white" style={{fontFamily: 'Inter, sans-serif'}}>
    <div className="max-w-6xl mx-auto">
      {/* Intro sentence */}
      <p className="text-blue-700 text-base md:text-lg text-center mb-2 font-medium">Discover what makes eKahera the smart choice for your business.</p>
