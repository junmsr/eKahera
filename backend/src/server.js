...
app.use(cors({ origin: ['https://ekahera.netlify.app', 'http://localhost:5173', 'https://1k4cjk2x-5173.asse.devtunnels.ms', 'https://junmsr.github.io', 'https://www.ekahera.online'], credentials: true }));
